sap.ui.define([
	...
	return Opa5.extend("com.marturfompak.propositionmanagement.propositionmanagement.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/marturfompak/propositionmanagement/propositionmanagement/localService/mockserver"], function (mockserver) {
